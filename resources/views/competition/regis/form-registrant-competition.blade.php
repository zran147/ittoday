...
<form class="bg-light p-3 my-5">
    ...
    <div class="row gy-4">
        ...
        @else
        <div class="col-md-12 gy-4 text-center my-3">
            <button type="button" class="btn btn-info">{{ $status_verification_tim }}</button>
        </div>
        @endif
    </div>
    ...
    <div class="mt-5" wire:ignore>
        <div class="row gy-4 ">
            <h2 class="text-center">Information Payment Team</h2>

            <div class="col-md-6 form-group">
                <label for="username_telegram_team" class="form-label">Team's Bank Account Name </label>
            ...
            <div class="col-md-6 form-group">
                <label for="username_telegram_team" class="form-label">fee payment Number</label>
            ...
            <div class="col-md-12 form-group">
                <label for="username_telegram_team" class="form-label">Payment Receipt</label>
        ...
        <div class="col-md-12 gy-4 text-center my-3">
            <button type="button" wire:click="{{ $actionpayment }}" class="btn btn-primary">{{ $actionpayment }} Payment Tim</button>
        </div>
        @else
        <div class="col-md-12 gy-4 text-center my-3">
    ...
    <div class="mt-5" wire:ignore>
        <div class="row gy-4 ">
            <h2 class="text-center">Result Team</h2>
