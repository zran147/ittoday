                                            ...
                                            @foreach ($permissions as $item)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        wire:model='permissionselect.{{ $loop->index }}'
                            ...
                            @can('edit-role')
                                @if ($form == 'editrole')
                                    <form wire:submit.prevent="updaterole('{{ $getidrole }}')">
                                        ...
                                        @foreach ($permissions as $item)
                                            <div class="form-check">
                                                <input wire:model='getpermissionrole' class="form-check-input"
                                                    type="checkbox" value="{{ $item->name }}" id="flexCheckDefault">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    {{ $item->name }}
                                                </label>
                                            </div>
                        ...
                        <div class="card-body">
                                ...
                                @if ($form == 'addpermission')
                                    <form class="my-2" wire:submit.prevent='storepermission'>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                aria-describedby="emailHelp" name="namepermission"
                                                wire:model='namepermission'>
                            ...
                            @can('edit-permission')
                                @if ($form == 'editpermission')
                                    <form class="mb-3"
                                        wire:submit.prevent='updatepermission({{ $idpermission }})'>
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">name permission</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                aria-describedby="emailHelp" name="namepermission"
